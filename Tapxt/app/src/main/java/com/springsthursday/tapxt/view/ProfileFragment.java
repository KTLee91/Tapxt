...
public class ProfileFragment extends Fragment implements ProfileContract.View {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        binding.tabLayout.addTab(binding.tabLayout.newTab().setText("최근 열람"));
        binding.tabLayout.addTab(binding.tabLayout.newTab().setText("좋아요"));

        binding.tabLayout.setTabGravity(TabLayout.GRAVITY_FILL);

        StoryListPagerAdapter pagerAdapter = new StoryListPagerAdapter(getActivity().getSupportFragmentManager(), binding.tabLayout.getTabCount(), this);
